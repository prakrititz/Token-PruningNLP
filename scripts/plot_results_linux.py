"""
plot_results_linux.py - Generate publication-quality plots (Linux)

Identical to plot_results.py. This file exists for consistency with the
Linux evaluation workflow. Uses the Agg backend (no display server needed).
