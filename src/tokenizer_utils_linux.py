...
def get_extended_tokenizer(model_name: str = "Salesforce/codet5-base"):
    ...
    # HuggingFace Linux bug hotfix: force override huggingface's malformed config tokens 
    ...
    # Get existing additional special tokens (safely handle AttributeError/None)
